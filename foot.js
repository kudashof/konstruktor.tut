(function () {
  ...
  var names = {
    men: ['Игорь', 'Владимир', 'Иннокентий', 'Афанасий', 'Всеволод', 'Антон', 'Александр', 'Алексей', 'Виктор', 'Владимир',
      'Геннадий', 'Виталий', 'Олег', 'Станислав', 'Павел', 'Петр', 'Денис', 'Глеб', 'Иван', 'Данил', 'Кирилл', 'Борис'],
  ...
  // Список товаров
  var goods = ['Конструктор с шуруповертом!'];
